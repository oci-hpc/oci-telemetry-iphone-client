...
export default class LapDistanceClock extends DefaultClock {
    constructor(period = 100) {
        super();

        this.key = 'lapDistanceClock';
        this.name = 'Lap Distance';
        this.description = "Provides UTC timestamps every second from the lap distance clock.";
